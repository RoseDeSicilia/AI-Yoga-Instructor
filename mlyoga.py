...
'''
todo: 
- take images of correct yoga landmarks to export into coord.csv instead of video feed 
- fix classification model
- fix Train Custom Model Using Scikit Learn
- fix Evaluate and Serialize Model
- fix Make Detections with Model
...
# Yoga-Ai Capture Landmarks Training data and export into csv format from images
